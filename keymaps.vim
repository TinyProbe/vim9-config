...
call Keymap("nnore", "<silent>", "<A-h>", "<cmd>OutdentNormal<cr>")
call Keymap("nnore", "<silent>", "<A-l>", "<cmd>IndentNormal<cr>")
call Keymap("nnore", "<silent>", "<A-j>", "<Plug>MoveLineDown")
call Keymap("nnore", "<silent>", "<A-k>", "<Plug>MoveLineUp")
call Keymap("vnore", "<silent>", "<A-h>", "<cmd>OutdentVisual<cr>")
call Keymap("vnore", "<silent>", "<A-l>", "<cmd>IndentVisual<cr>")
