...
call Keymap("n", "", "<leader>c", "<Plug>Commentary")
call Keymap("x", "", "<leader>c", "<Plug>Commentary")
call Keymap("o", "", "<leader>c", "<Plug>Commentary")
call Keymap("n", "", "<leader>cc", "<Plug>CommentaryLine")
call Keymap("n", "", "<leader>cu", "<Plug>Commentary<Plug>Commentary")
