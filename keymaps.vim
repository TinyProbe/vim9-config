...
g:Keymap("nnore", "<silent>", "<A-h>", "<cmd>UsrCmdOutdentNormal<cr>")
g:Keymap("nnore", "<silent>", "<A-l>", "<cmd>UsrCmdIndentNormal<cr>")
g:Keymap("nnore", "<silent>", "<A-j>", "<Plug>MoveLineDown")
g:Keymap("nnore", "<silent>", "<A-k>", "<Plug>MoveLineUp")
g:Keymap("vnore", "<silent>", "<A-h>", "<cmd>UsrCmdOutdentVisual<cr>")
g:Keymap("vnore", "<silent>", "<A-l>", "<cmd>UsrCmdIndentVisual<cr>")
g:Keymap("vnore", "<silent>", "<A-j>", "<Plug>MoveBlockDown")
g:Keymap("vnore", "<silent>", "<A-k>", "<Plug>MoveBlockUp")
